...
export function CompanyCard(props: CompanyCardProps): JSX.Element {
    ...
    function handleDelete() {
        const bool = window.confirm('Are you sure you want to delete this coupon?(' + props.company?.name + ')');
        if (bool)
                        ...
                        <CardActionArea>
                            ...
                            <CardContent sx={{
                                ...
                                <Box>
                                    ...
                                    <Typography marginBottom={1} noWrap><strong>Email: </strong>{props.company?.email}</Typography>
                                </Box>
                            </CardContent>
                        </CardActionArea>
                    </Card>
